...
GUIFrame.ModuleCatalog = {
    ...
    { id = "ConsumableReminder", label = "Consumable Reminder", group = "qol",
      title = "Consumable Reminder", dbKey = "consumableReminder",
      settings = { "font", "position" },
      about = "Shows an on-screen reminder listing tracked consumables whose bag count falls below their threshold, so you know when to stock up. Ranks of the same consumable are counted together." },
